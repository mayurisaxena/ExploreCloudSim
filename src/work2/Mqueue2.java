...
import work2.RR3;
import work2.CloudletSpace;
import work2.CloudletTime;
	...
	public class Mqueue2 {
		...
		public static void main(String[] args) {
			...
			try {
				...
				//create VMs
				Vm vm1 = new Vm(vmid, brokerId,5000, pesNumber, ram, bw, size, vmm, v2);
				vmid++;
				Vm vm2 = new Vm(vmid, brokerId, 1000, pesNumber, ram, bw, size, vmm, v3);
				vmid++;
				Vm vm3 = new Vm(vmid, brokerId, 10000, pesNumber, ram, bw, size, vmm, v1);
