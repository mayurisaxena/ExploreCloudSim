...
public class CloudletSpace extends CloudletScheduler {
	...
	public double updateVmProcessing(double currentTime, List<Double> mipsShare) {
		...
		System.out.println(" Calling !!!!!!!!!!!!!!!!!!!!!!!!!!" + currentTime);
		...
		for (ResCloudlet rcl : getCloudletExecList()) {
			...
			if (rcl.getRemainingCloudletLength() == rcl.getCloudletTotalLength()){
				ResponseTime.set(rcl.getCloudletId(), getPreviousTime());
			...
			//System.out.println(timeSpam);
			
			System.out.println("Cloudlet Id  "+ rcl.getCloudletId() + " updated  " + capacity * timeSpam * rcl.getNumberOfPes() );
			System.out.println("remaining length   " + rcl.getRemainingCloudletLength() );		
		...
		for (ResCloudlet rcl : getCloudletExecList()) {
			...
			if (rcl.getRemainingCloudletLength() == 0) {
					...
					finishTime.set(rcl.getCloudletId(), currentTime);
