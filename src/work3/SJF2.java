...
public class SJF2{
	...
	public static void main(String[] args) {
		...
		try {
			...
			id++;
			MyCloudlet cloudlet7 = new MyCloudlet(id, 9500, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel,1);
	...
	private static void shortestJob (List<MyCloudlet> cl , List<Vm> vm , MyDatacenterBroker broker)
	{
		int c , v ;
		c = cl.size();
		v = vm.size();
