...
public class Mqueue2try {
	...
	public static void main(String[] args) {
		...
		try {
			...
			RR3 v1 = new RR3();
			CloudletTime v2 = new CloudletTime();
			...
			//create VMs
			Vm vm1 = new Vm(vmid, brokerId,10000, pesNumber, ram, bw, size, vmm, v1);
			vmid++;
			Vm vm2 = new Vm(vmid, brokerId, 5000, pesNumber, ram, bw, size, vmm, v2);
			vmid++;
			Vm vm3 = new Vm(vmid, brokerId, 1000, pesNumber, ram, bw, size, vmm, v3);
...
//			broker1.submitVmList(vmList1);
			...
			MyCloudlet cloudlet1 = new MyCloudlet(id, 700, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel,9.6);
			cloudlet1.setUserId(brokerId);

			id++;
			MyCloudlet cloudlet2 = new MyCloudlet(id,900, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel,8.5);
			cloudlet2.setUserId(brokerId);

			id++;
			MyCloudlet cloudlet3 = new MyCloudlet(id, 2000, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel,13);
			cloudlet3.setUserId(brokerId);
			
			id++;
			MyCloudlet cloudlet4 = new MyCloudlet(id, 4000, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel,7.8);
			cloudlet4.setUserId(brokerId);
			
			id++;
			MyCloudlet cloudlet5 = new MyCloudlet(id, 4500, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel,4.5);
			cloudlet5.setUserId(brokerId);
			
			id++;
			MyCloudlet cloudlet6 = new MyCloudlet(id, 6000, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel,11.5);
			cloudlet6.setUserId(brokerId);
			
			id++;
			MyCloudlet cloudlet7 = new MyCloudlet(id, 7000, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel,5.6);
			cloudlet7.setUserId(brokerId);
			
			id++;
			MyCloudlet cloudlet8 = new MyCloudlet(id, 8000, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel,7.2);
			cloudlet8.setUserId(brokerId);
			
			id++;
			MyCloudlet cloudlet9 = new MyCloudlet(id, 9500, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel,9.5);
			cloudlet9.setUserId(brokerId);
			
		/*	id++;
			MyCloudlet cloudlet10 = new MyCloudlet(id, 20000, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel,11);
			cloudlet10.setUserId(brokerId);
			
			id++;
			MyCloudlet cloudlet11 = new MyCloudlet(id, 30000, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel,12);
			cloudlet11.setUserId(brokerId);

			id++;
			MyCloudlet cloudlet12 = new MyCloudlet(id,50000, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel,10);
			cloudlet12.setUserId(brokerId);
			
		*/
			id++;
			Cloudlet cloudlet10 = new Cloudlet(id, 20000, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
			cloudlet10.setUserId(brokerId);
			
			id++;
			Cloudlet cloudlet11 = new Cloudlet(id, 30000, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
			cloudlet11.setUserId(brokerId);

			id++;
			Cloudlet cloudlet12 = new Cloudlet(id,50000, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
			cloudlet12.setUserId(brokerId);
			...
			cloudletList1.add(cloudlet11);
			cloudletList1.add(cloudlet12);

			
			
			cloudlet10.setVmId(0);
			cloudlet11.setVmId(0);
			cloudlet12.setVmId(0);
