...
import work.RR3;
import work.CloudletSpace;
import work.CloudletTime;
	...
	public class MQueue {
		...
		public static void main(String[] args) {
			...
			try {
				...
				Cloudlet cloudlet1 = new Cloudlet(id, 700, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
				cloudlet1.setUserId(brokerId);

				id++;
				Cloudlet cloudlet2 = new Cloudlet(id,20000, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
				cloudlet2.setUserId(brokerId);

				id++;
				Cloudlet cloudlet3 = new Cloudlet(id, 3000, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
				cloudlet3.setUserId(brokerId);
				
				id++;
				Cloudlet cloudlet4 = new Cloudlet(id, 900, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
				cloudlet4.setUserId(brokerId);
				
				id++;
				Cloudlet cloudlet5 = new Cloudlet(id, 10000, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
				cloudlet5.setUserId(brokerId);
				
				id++;
				Cloudlet cloudlet6 = new Cloudlet(id, 3500, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
				cloudlet6.setUserId(brokerId);
				
				id++;
				Cloudlet cloudlet7 = new Cloudlet(id, 30000, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
				cloudlet7.setUserId(brokerId);
				
				id++;
				Cloudlet cloudlet8 = new Cloudlet(id, 900, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
				cloudlet8.setUserId(brokerId);
				
				id++;
				Cloudlet cloudlet9 = new Cloudlet(id, 10000, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
				cloudlet9.setUserId(brokerId);
				
				id++;
				Cloudlet cloudlet10 = new Cloudlet(id, 3500, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
				cloudlet10.setUserId(brokerId);
				
				id++;
				Cloudlet cloudlet11 = new Cloudlet(id, 700, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
				cloudlet11.setUserId(brokerId);

				id++;
		//		Cloudlet cloudlet12 = new Cloudlet(id,20000, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
		...
		private static void allocateCloudletQueue (List<Cloudlet> cl , List<Vm> vm , DatacenterBroker broker)
		{
			int c , v ;
			c = cl.size();
			v = vm.size();
		...
		//	for (int i=0;i<v;i++)
			...
			while (i<c)
			{
				...
				for ( g=0; g<v;g++)
				{
					...
					if (c1.getCloudletTotalLength() < 1000 && v1.getMips() <=1000)
					{
						broker.bindCloudletToVm(c1.getCloudletId(),v1.getId());
					...
					else if (c1.getCloudletTotalLength() < 5000 && v1.getMips() <=5000 && v1.getMips()>1000 && c1.getCloudletTotalLength()>=1000)
					{
						broker.bindCloudletToVm(c1.getCloudletId(),v1.getId());
					...
					else if (v1.getMips() <=10000 && v1.getMips()>5000 && c1.getCloudletTotalLength()>=5000)
					{
						broker.bindCloudletToVm(c1.getCloudletId(),v1.getId());
