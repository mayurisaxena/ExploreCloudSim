...
public class MyTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Vm vm = new Vm(0, brokerId, mips, pesNumber, ram, bw, size, vmmachine, new CloudletSpace());
			Vm vm2 = new Vm(1, brokerId, mips, pesNumber, ram, bw, size, vmmachine, new CloudletSpace());
			vmlist.add(vm);
			//vmlist.add(vm2);
			...
			long fileSize = 300;
			long outputSize = 300;
			double startTime[]={0.0,1000,1500};
