	...
	public class RR_2 {
		...
		public static void main(String[] args) {
			...
			try {
				...
				vmid++;
				Vm vm5 = new Vm(vmid, brokerId, 5000, pesNumber, ram, bw, size, vmm,v5);
				
				vmid++;
				Vm vm6 = new Vm(vmid, brokerId, 10000, pesNumber, ram, bw, size, vmm, v6);
				vmid++;
				Vm vm7 = new Vm(vmid, brokerId, 1000, pesNumber, ram, bw, size, vmm, v7);
