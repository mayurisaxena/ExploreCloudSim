...
public class ShortestJobF{
	...
	public static void main(String[] args) {
		...
		try {
			...
			CloudletSpace v5 = new CloudletSpace();
			...
			vmid++;
			Vm vm3 = new Vm(vmid, brokerId, 5000, pesNumber, ram, bw, size, vmm, v3);
			
			vmid++;
			Vm vm4 = new Vm(vmid, brokerId, 1000, pesNumber, ram, bw, size, vmm,v4);
			
			vmid++;
			Vm vm5 = new Vm(vmid, brokerId, 10000, pesNumber, ram, bw, size, vmm,v5);
			
			vmid++;
			Vm vm6 = new Vm(vmid, brokerId, mips, pesNumber, ram, bw, size, vmm, v6);
...
//			cloudletList.add(cloudlet12);
			...
			shortestJob (cloudletList , vmlist, broker);
	...
	private static void shortestJob (List<Cloudlet> cl , List<Vm> vm , DatacenterBroker broker)
	{
		int c , v ;
		c = cl.size();
		v = vm.size();
